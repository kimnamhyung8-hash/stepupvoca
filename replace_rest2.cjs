...
// Remove Node require if we use import
code = code.replace("const { auth } = require('./firebase');", "import { auth } from './firebase';");
// Wait, regex might fail because import must be at the top!
